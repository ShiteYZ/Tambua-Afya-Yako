...
<div class="row">            
      <div class="col-md-3">
            <br><br>
          <div class="habari">MAGONJWA YASIYO YA KUAMBUKIZWA</div>
          <div class="magonjwa">
               <ul>
            <li><a class="active" href="index.php?p=cancer">SARATANI</a></li>
            <li><a href="index.php?p=pressure">SHINIKIZO LA DAMU</a></li>
            <li><a href="index.php?p=pumu">PUMU</a></li>
            <li><a href="index.php?p=urcers">VIDONDA VYA TUMBO</a></li>
           </ul>
           </div>
        </div>
         <div class="col-md-9">
